...
(function (f) {
  ...
  var define, module, exports;return function e(t, n, r) {
    function s(o, u) {
      ...
      var _require = require("htmlcoinjs-ethjs-abi"),
      ...
      var Contract = function () {
         ...
         *      [solar](https://github.com/htmlcoinproject/solar). It includes the contract
    ...
    }, { "./MethodMap": 3, "./TxReceiptPromise": 7, "./abi": 8, "eventemitter3": 37, "htmlcoinjs-ethjs-abi": 42 }], 2: [function (require, module, exports) {
      "use strict";
      ...
      var ContractsRepo = function () {
        function ContractsRepo(htmlcoin, repoData) {
          _classCallCheck(this, ContractsRepo);

          this.htmlcoin = htmlcoin;
        ...
        _createClass(ContractsRepo, [{
          ...
          value: function contract(name) {
            ...
            return new Contract_1.Contract(this.htmlcoin, info, { logDecoder: this.logDecoder });
          }
          /**
      ...
      Object.defineProperty(exports, "__esModule", { value: true });
      var HtmlcoinRPC_1 = require("./HtmlcoinRPC");
      ...
      var Htmlcoin = function (_HtmlcoinRPC_1$HtmlcoinRPC) {
        _inherits(Htmlcoin, _HtmlcoinRPC_1$HtmlcoinRPC);

        function Htmlcoin(providerURL, repoData) {
          _classCallCheck(this, Htmlcoin);

          var _this = _possibleConstructorReturn(this, (Htmlcoin.__proto__ || Object.getPrototypeOf(Htmlcoin)).call(this, providerURL));
        ...
        return Htmlcoin;
      }(HtmlcoinRPC_1.HtmlcoinRPC);

      exports.Htmlcoin = Htmlcoin;
    }, { "./ContractsRepo": 2, "./HtmlcoinRPC": 5 }], 5: [function (require, module, exports) {
      "use strict";
      ...
      Object.defineProperty(exports, "__esModule", { value: true });
      var HtmlcoinRPCRaw_1 = require("./HtmlcoinRPCRaw");
      ...
      var HtmlcoinRPC = function (_HtmlcoinRPCRaw_1$HtmlcoinRPC) {
        _inherits(HtmlcoinRPC, _HtmlcoinRPCRaw_1$HtmlcoinRPC);

        function HtmlcoinRPC() {
          _classCallCheck(this, HtmlcoinRPC);

          return _possibleConstructorReturn(this, (HtmlcoinRPC.__proto__ || Object.getPrototypeOf(HtmlcoinRPC)).apply(this, arguments));
        }

        _createClass(HtmlcoinRPC, [{
          key: "getInfo",
        ...
        return HtmlcoinRPC;
      }(HtmlcoinRPCRaw_1.HtmlcoinRPCRaw);

      exports.HtmlcoinRPC = HtmlcoinRPC;
    }, { "./HtmlcoinRPCRaw": 6 }], 6: [function (require, module, exports) {
      "use strict";
      ...
      var HtmlcoinRPCRaw = function () {
        function HtmlcoinRPCRaw(_baseURL) {
          _classCallCheck(this, HtmlcoinRPCRaw);
    ...
    }, { "htmlcoinjs-ethjs-abi": 42 }], 9: [function (require, module, exports) {
      (function (Buffer) {
        "use strict";
        ...
        __export(require("./HtmlcoinRPC"));
        __export(require("./Htmlcoin"));
        __export(require("./TxReceiptPromise"));
      }).call(this, require("buffer").Buffer);
    }, { "./Contract": 1, "./Htmlcoin": 4, "./HtmlcoinRPC": 5, "./TxReceiptPromise": 7, "./abi": 8, "buffer": 49 }], 10: [function (require, module, exports) {
      "use strict";
    ...
    }, { "./helpers/bind": 25, "is-buffer": 38 }], 36: [function (require, module, exports) {
      ...
      (function (process, global) {
        ...
        (function (root) {
          ...
          var COMMON_JS = !root.JS_SHA3_TEST && (typeof module === "undefined" ? "undefined" : _typeof(module)) == 'object' && module.exports;
    ...
    }, { "_process": 51 }], 41: [function (require, module, exports) {
    ...
    }, { "bn.js": 36, "strip-hex-prefix": 46 }], 42: [function (require, module, exports) {
      /* eslint-disable */
      /*
      Primary Attribution
    ...
    }, { "./utils/index.js": 43, "buffer": 49 }], 43: [function (require, module, exports) {
      /*
      Primary Attribution
      Richard Moore <ricmoo@me.com>
      https://github.com/ethers-io
      ...
      function coderNumber(size, signed) {
        return {
          encode: function encodeNumber(valueInput) {
            ...
            if ((typeof value === "undefined" ? "undefined" : _typeof(value)) === 'object' && value.toString && (value.toTwos || value.dividedToIntegerBy)) {
    ...
    }, { "bn.js": 36, "buffer": 49, "js-sha3": 40, "number-to-bn": 41 }], 44: [function (require, module, exports) {
      'use strict';
    ...
    }, { "is-hex-prefixed": 39 }], 47: [function (require, module, exports) {
      (function (global) {
        'use strict';
    ...
    }, { "querystringify": 44, "requires-port": 45 }], 48: [function (require, module, exports) {
      'use strict';
